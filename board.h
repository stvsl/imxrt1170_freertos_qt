...
#define BOARD_ENET_PHY0_RESET                                                  \
  GPIO_WritePinOutput(BOARD_ENET_PHY0_RESET_GPIO,                              \
                      BOARD_ENET_PHY0_RESET_GPIO_PIN, 0);                      \
  SDK_DelayAtLeastUs(10000, CLOCK_GetFreq(kCLOCK_CpuClk));                     \
  GPIO_WritePinOutput(BOARD_ENET_PHY0_RESET_GPIO,                              \
                      BOARD_ENET_PHY0_RESET_GPIO_PIN, 1);                      \
...
/* For a complete PHY reset of RTL8211FDI-CG, this pin must be asserted low for
 * at least 10ms. And wait for a further 30ms(for internal circuits settling
 * time) before accessing the PHY register */
#define BOARD_ENET_PHY1_RESET                                                  \
  GPIO_WritePinOutput(BOARD_ENET_PHY1_RESET_GPIO,                              \
                      BOARD_ENET_PHY1_RESET_GPIO_PIN, 0);                      \
  SDK_DelayAtLeastUs(10000, CLOCK_GetFreq(kCLOCK_CpuClk));                     \
  GPIO_WritePinOutput(BOARD_ENET_PHY1_RESET_GPIO,                              \
                      BOARD_ENET_PHY1_RESET_GPIO_PIN, 1);                      \
...
/* Below comment is for test script to easily define which port to be used,
 * please don't delete. */
/* @TEST_ANCHOR */
